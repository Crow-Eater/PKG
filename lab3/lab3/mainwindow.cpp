    ...
    else
    {
        ...
        case imageProccess::bilateral:
            ...
            case imageProccess::Adaptive:
                img = QImage(":/images/adaptive1.jpg");
...
void MainWindow::on_medianeblur_triggered()
{
    curProccess = imageProccess::medianeBlur;
    cv::Mat cvdst, cvsrc;
    getSrc(cvsrc, cvdst);
    cv::medianBlur(cvsrc, cvdst, 3);
    setData(cvsrc, cvdst);
}


void MainWindow::on_bilateral_triggered()
{
    curProccess = imageProccess::medianeBlur;
    cv::Mat cvdst, cvsrc;
    getSrc(cvsrc, cvdst);
    cv::bilateralFilter(cvsrc, cvdst, 40, 80, 20);
    setData(cvsrc, cvdst);
}
...
void MainWindow::on_adaptive_thresholding_triggered()
{
    ...
    cv::Mat cvdst, cvsrc;
    getSrc(cvsrc, cvdst);
    cv::adaptiveThreshold(cvsrc, cvdst, 255, cv::AdaptiveThresholdTypes::ADAPTIVE_THRESH_MEAN_C, cv::ThresholdTypes::THRESH_BINARY, 7, 12);
    setData(cvsrc, cvdst);
}
